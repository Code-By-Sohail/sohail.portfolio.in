        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div ref={infoRef} className="order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <ul className="space-y-4 mb-10 w-full max-w-md">
              ...
              <li className="flex items-center gap-3 glass p-4 rounded-xl border border-white/5">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-neon-blue/10 text-neon-blue flex items-center justify-center">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <li className="flex items-center gap-3 glass p-4 rounded-xl border border-white/5">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-neon-emerald/10 text-neon-emerald flex items-center justify-center">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div className="text-left">
                  ...
                  <span className="block text-slate-400 text-sm">Book a <strong className="text-neon-emerald">100% Free</strong> strategy consultation today.</span>
                </div>
              </li>
            </ul>
          ...
          <div ref={cardRef} className="order-1 lg:order-2 w-full max-w-md mx-auto relative group">
            ...
            <div className="absolute inset-0 bg-neon-blue rounded-3xl opacity-20 blur-3xl transition-opacity duration-500 group-hover:opacity-40 pointer-events-none" />
                  ...
                  <MagneticButton className="w-full block">
                    <button
                      ...
                      className="
                         ...
                         hover:shadow-[0_0_30px_rgba(0,136,255,0.6)]
